...
Customer Records Information System 2 / Update: AB
    ...
    Screenshot.Take Screenshot        CRISAB_launchIMSE.jpg 
    ...
    Screenshot.Take Screenshot        CRISAB_Dashboard.jpg 
    ...
    Send Enter
    sleep    2s
    Screenshot.Take Screenshot        CRISAB_installOrder.jpg
    ...
    Delete Field    23    047
    Send Enter
    Screenshot.Take Screenshot        CRISAB_bscPage.jpg
    Log To Console    ${\n}Step4- Enter BSC Page Details and Go to the LST Screen
    Write Bare in Position    ${IN_SVC}    08    007
    Send Enter
    Send Enter
    Screenshot.Take Screenshot        CRISAB_lstPage.jpg
    ...
    Send Enter
    Screenshot.Take Screenshot        CRISAB_ccdPage.jpg
    Log To Console    ${\n}Step6- Enter CCD Page Details & skip CLR Page and Jump to the EQP Screen
    Send PF    9
    Send Enter
    Send Enter
    Screenshot.Take Screenshot        CRISAB_eqpPage.jpg
    ...
    Send Enter
    Send Enter
    Screenshot.Take Screenshot        CRISAB_rmkPage.jpg
    ...
    Send Enter
    Screenshot.Take Screenshot        CRISAB_verifyRmkDetails.jpg
    Send Enter
    Delete Field    23    047
    Delete Field    23    079
    Write Bare in Position    sor    23    030
    Send Enter
    Screenshot.Take Screenshot        CRISAB_complitionDetails.jpg
    ...
    Write Bare in Position    sor    23    030
    Send Enter
    Screenshot.Take Screenshot        CRISAB_verifyCompletedStatus.jpg
    ...
    Send PF    1
    Screenshot.Take Screenshot        CRISAB_logOut.jpg
    ...
    Should Be Equal As Strings    ${CRIS_APP_LOGINPAGE}    ${read_app_loginTitle}
    Screenshot.Take Screenshot        CRISAB_logOutPage.jpg
